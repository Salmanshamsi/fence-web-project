        ...
        <div className='lg:px-20 px-10 py-10 flex flex-col  justify-center gap-5'>
            <h1 className='lg:text-5xl text-3xl font-bold border-b-4 pb-5' >Design and Buy <sup className='text-2xl' >TM</sup> Fence</h1>
                ...
                <ul className='lg:text-xl text-sm font-medium lg:ps-5 flex flex-col gap-3 '>
                    <li className='flex flex-row gap-4' ><h1><i className="fa-solid fa-feather-pointed"></i></h1> Multiple Materials</li>
                    <li className='flex flex-row gap-4' ><h1><i className="fa-solid fa-feather-pointed"></i></h1> Custom Drawn Layout</li>
                    <li className='flex flex-row gap-4' ><h1><i className="fa-solid fa-feather-pointed"></i></h1> Add Gates & Openings</li>
                    <li className='flex flex-row gap-4' ><h1><i className="fa-solid fa-feather-pointed"></i></h1> Draw With Google Maps</li>
                </ul>
