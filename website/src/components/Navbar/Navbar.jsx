...
const Navbar = () => {
  ...
  return (
    <>
    <div className='hidden h-12 lg:flex  bg-green-700 text-white ' >
            ...
            <ul className='flex  w-full gap-10 justify-end pr-20 h-full items-center p-2' >
                <li className='flex gap-2 items-center cursor-pointer' ><h1><i class="fa-solid fa-sd-card "></i></h1> save</li>
                <li className='flex gap-2 items-center cursor-pointer' ><h1><i class="fa-solid fa-sd-card "></i></h1> save as</li>
                <li className='flex gap-2 items-center cursor-pointer' ><h1><i class="fa-solid fa-file-circle-question"></i></h1> FAQ</li>
                <li className='flex gap-2 items-center cursor-pointer' ><h1><i class="fa-solid fa-user"></i></h1> Login</li>
            </ul>
            {/* Mobile screen */}
    </div>
      <div className='lg:hidden h-auto p-4 flex bg-green-700 text-white'>
      ...
      <ul className={`w-full ${Openmenu}`} >
          ...
          <li className='w-full flex items-center justify-center border p-3 bg-green-700 hover:bg-white text-white hover:text-green-700' >
            <ul className='flex items-center justify-center gap-3 p-3 transition-all transform duration-300' >
                <li className='flex gap-2 items-center cursor-pointer' ><h1><i class="fa-solid fa-sd-card "></i></h1> save</li>
                <li className='flex gap-2 items-center cursor-pointer' ><h1><i class="fa-solid fa-sd-card "></i></h1> save as</li>
                <li className='flex gap-2 items-center cursor-pointer' ><i class="fa-solid fa-file-circle-question"></i> FAQ</li>
            </ul>
          </li>
      </ul>
      </>
