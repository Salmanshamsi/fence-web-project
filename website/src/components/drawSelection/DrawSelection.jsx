    ...
    <div className='h-full lg:p-24 lg:gap-8 gap-16 w-full text-gray-700 flex flex-col justify-center items-center '>
        ...
        <div className='flex w-full lg:flex-row flex-col  lg:gap-0  gap-5' >
            ...
            <div className='w-full flex-col gap-20 flex items-center justify-center' >
                ...
                <button className='text-center text-white flex items-center justify-center w-28 transition duration-100 hover:-translate-y-1 lg:w-44 lg:p-4 p-2 lg:text-lg text-md h-12 bg-green-800 rounded-full ' onClick={moveToCanvas}>Enter Dimensions</button>
            </div>
        </div>
    </div>
  )
