                    ...
                    <div className='w-full h-full bg-white flex flex-col p-4' >
                        <ul>
                            <li className='flex justify-between' >
                                <span className='font-semibold' >Merchandies Subtotal</span><span>${cart[0]?.totalPrice}</span>
                            </li>
                            <li className='flex justify-between' >
                                <span className='font-semibold' >Pretax Subtotal</span><span>${cart[0]?.totalPrice}</span>
                            </li>
                        </ul>
                    </div>
                    <div className='w-full h-full bg-white flex flex-col p-4' >
                        ...
                        <div className='mt-2' >
                            ...
                            }} className='w-full h-12 bg-slate-300 rounded-full text-white font-semibold shadow-sm' >CHECKOUT NOW</button>
                        </div>
                    </div>
                </div>
            </div>
