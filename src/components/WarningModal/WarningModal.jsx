...
const WarningModal = ({isOpen, heading, content,setIsOpen, navigate}) => {
  ...
  return (
    ...
    <div className={`fixed inset-0 overflow-y-auto ${isOpen ? 'visible opacity-100' : 'invisible opacity-0' } z-50`} >
      <div className="flex items-start mt-14 justify-center min-h-screen">
        ...
        <div className={`relative z-10 transition-transform  duration-700  transform ${isOpen ? 'translate-y-0' : '-translate-y-full'} flex flex-col gap-4 bg-white w-full max-w-md mx-auto rounded-lg shadow-md`}>
